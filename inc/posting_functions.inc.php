...
function hesk_newTicket($ticket)
{
	...
	// Generate SQL code for inserting the ticket into database
	$sql = "
	...
	// Define array with ticket info for use in emails
	$info = array(
	'email'			=> $ticket['email'],
	...
	'status'		=> 0,
	'name'			=> hesk_msgToPlain($ticket['name'], 1),
	'lastreplier'	=> hesk_msgToPlain($ticket['name'], 1),
	'subject'		=> hesk_msgToPlain($ticket['subject'], 1),
	...
	{
		$info[$k] = $v['use'] ? hesk_msgToPlain($ticket[$k], 1) : '';
	}
